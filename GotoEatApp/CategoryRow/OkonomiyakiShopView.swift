...
struct OkonomiyakiShopView: View {
    var shop: OkonomiyakiShop
...
struct OkonomiyakiShopView_Previews: PreviewProvider {
    static var previews: some View {
        let shop = [OkonomiyakiShop]()
        NavigationView{
            OkonomiyakiShopView(shop: shop[2])
        }
    }
}
