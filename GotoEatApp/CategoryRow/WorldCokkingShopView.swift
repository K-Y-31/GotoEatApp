...
struct WorldCokkingShopView: View {
    var shop: WorldCookingShop
...
struct WorldCokkingShopView_Previews: PreviewProvider {
    static var previews: some View {
        let shop = [WorldCookingShop]()
        NavigationView{
            WorldCokkingShopView(shop: shop[2])
        }
    }
}
