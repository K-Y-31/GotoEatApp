...
struct YakinikuShopView: View {
    var shop: YakinikuShop
...
struct YakinikuShopView_Previews: PreviewProvider {
    static var previews: some View {
        let shop = [YakinikuShop]()
        NavigationView{
            YakinikuShopView(shop: shop[2])
        }
    }
}
