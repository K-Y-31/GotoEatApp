...
struct YoushokuShopView: View {
    var shop: YoushokuShop
...
struct YoushokuShopView_Previews: PreviewProvider {
    static var previews: some View {
        let shop = [YoushokuShop]()
        NavigationView{
            YoushokuShopView(shop: shop[2])
        }
    }
}
