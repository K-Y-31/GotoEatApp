...
struct WashokuShopView: View {
    var shop: WashokuShop
...
struct WashokuShopView_Previews: PreviewProvider {
    static var previews: some View {
        let shop = [WashokuShop]()
        NavigationView{
            WashokuShopView(shop: shop[2])
        }
    }
}
