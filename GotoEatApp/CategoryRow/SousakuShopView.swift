...
struct SousakuShopView: View {
    var shop: SousakuShop
...
struct SousakuShopView_Previews: PreviewProvider {
    static var previews: some View {
        let shop = [SousakuShop]()
        NavigationView{
            SousakuShopView(shop: shop[2])
        }
    }
}
