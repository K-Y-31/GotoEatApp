...
struct CaraokeShopView: View {
    var shop: CaraokeShop
...
struct CaraokeShopView_Previews: PreviewProvider {
    static var previews: some View {
        let shop = [CaraokeShop]()
        NavigationView{
            CaraokeShopView(shop: shop[2])
        }
    }
}
