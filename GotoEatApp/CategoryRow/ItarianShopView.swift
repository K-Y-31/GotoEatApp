...
struct ItarianShopView: View {
    var shop: ItarianShop
...
struct ItarianShopView_Previews: PreviewProvider {
    static var previews: some View {
        let shop = [ItarianShop]()
        NavigationView{
            ItarianShopView(shop: shop[2])
        }
    }
}
