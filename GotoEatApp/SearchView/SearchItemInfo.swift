//
//  SearchItemInfo.swift
//  GotoEatApp
//
//  Created by 木本瑛介 on 2021/05/29.
//

import SwiftUI
import MapKit

struct SearchItemInfo: View {
    var shop: SearchShop
...
struct SearchItemInfo_Previews: PreviewProvider {
    static var previews: some View {
        SearchItemInfo(shop: [SearchShop]()[0])
    }
}
